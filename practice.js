define(['pipAPI' ,'./extension_biat.js'], function(APIConstructor, iatExtension) {var API = new APIConstructor(); return iatExtension({
    ...
    "instTemplate": "<div><p style=\"font-size:20px; font-family:Arial sans-serif; text-align:center;\"><br/><span style=\"color=\"#ff0000\"><u>Parte blockNum di nBlocks </u><br/><br/></span></p><p style=\"font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:Arial sans-serif;\">Premi con l'indice destro il tasto <b>I</b> per le parole che appartengono alla categoria <span style=\"color:#0000FF\">focalAtt</span>, e per le parole che appartengono alla categoria <span style=\"color:#31b404\">focalCat</span>.<br/>Premi con l'indice sinistro il tasto <b>E</b> per le parole che non appartengono a queste categorie.<br/><br/>Se commetti un errore, una <span style=\"color:#ff0000\"><b>X</b></span> rossa apparirà. Premi l'altro tasto per continuare.<br/><br/><p style=\"text-align:center;\">Premi la <b>barra spaziatrice</b> quando sei pronta/o per iniziare.</span></p></div>"
});});
