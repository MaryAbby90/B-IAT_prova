define(['pipAPI' ,'https://cdn.jsdelivr.net/gh/baranan/minno-tasks@0.*/BIAT/biat6.js'], function(APIConstructor, iatExtension) {var API = new APIConstructor(); return iatExtension({
    ...
    "orText": "e",
    "remindErrorText": "<p style=\"font-size:1.4em;font-family:arial sans-serif; text-align:center;\">Se commetti un errore, una <font color="#ff0000"><b>X</b></font> rossa apparirà. Premi l'altro tasto per continuare.<p/>",
