define(['managerAPI',
	...
	// Aggiungi la data e ora di inizio
    var startTime = new Date().toISOString();  // Data di inizio in formato ISO
    API.addGlobal('startTime', startTime);  // Aggiungi startTime come variabile globale
    ...
    },
    {
        ...
        {
            type: 'post',
            path: ['startTime', 'endTime', 'status']
        },
	
	{inherit: 'uploading'},

     // Task finale per settare endTime e status
        {
            type: 'post',
            path: ['startTime', 'endTime', 'status'],
            // Aggiungi endTime e status in base a condizioni
            func: function() {
                ...
                API.addGlobal('endTime', endTime);
                API.addGlobal('status', status);
            }
        },
        {inherit: 'debriefing'},
        {inherit: 'redirect'}
