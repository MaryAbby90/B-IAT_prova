   ...
   API.addSequence([
    {
      ...
      questions : [{
        ...
        '<p>- In qualsiasi momento puoi decidere di ritirare il tuo consenso, contattando i responsabili dello studio, agli indirizzi e-mail: <a href=maddalena.marini@unicampania.it>maddalena.marini@unicampania.it</a> e <a href=sebastiano.costa@unicampania.it>sebastiano.costa@unicampania.it</a>. Nel caso decidessi di ritirare il consenso al trattamento dei dati, i Responsabili dello studio si impegnano fin da ora ad eliminare tutti i dati e le informazioni da te fornite.</p>' +
