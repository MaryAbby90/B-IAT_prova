   ...
   API.addSequence([
    {
      ...
      questions : [{
        ...
        '<p>- Tutti i dati personali saranno sottoposti a modalità di trattamento sia cartaceo sia elettronico e/o automatizzato, quindi con modalità sia manuali sia informatiche, e verranno conservati da Mariangela Abbate, dottoranda; Maddalena Marini, professore associato; Sebastiano Costa, professore ordinario. Tutti i dati saranno archiviati su computer e server protetti da password a cui avranno accesso solo i ricercatori.</p>' +
        ...
        '<p>- La comunicazione dei risultati dello studio a soggetti terzi nel corso di congressi e convegni scientifci, così come la pubblicazione per scopi scientifici potranno avvenire soltanto in forma aggregata e assolutamente anonima, a cura e sotto la responsabilità diretta dei responsabili della ricerca.</p>' +
        '<p>- In qualsiasi momento puoi decidere di ritirare il tuo consenso, contattando i responsabili dello studio, agli indirizzi e-mail: <a href=maddalena.marini@unicampania.it>maddalena.marini@unicampania.it</a> e <a href=sebastiano.costa@unicampania.it>sebastiano.costa@unicampania.it</a>. Nel caso decidessi di ritirare il consenso al trattamento dei dati, la Responsabile dello studio si impegna fin da ora ad eliminare tutti i dati e le informazioni da te fornite.</p>' +
